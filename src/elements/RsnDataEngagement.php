...
namespace percipioglobal\rsndataengagement\elements;

use percipioglobal\rsndataengagement\RsnDataEngagementElement;
 ...
 * @since     1.0.0
 */
class RsnDataEngagement extends Element
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('rsn-data-engagement', 'RsnDataEngagement');
    }
