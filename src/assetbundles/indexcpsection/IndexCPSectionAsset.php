...
namespace percipioglobal\rsndataengagement\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@percipioglobal/rsndataengagement/assetbundles/indexcpsection/dist";
