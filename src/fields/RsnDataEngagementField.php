...
namespace percipioglobal\rsndataengagement\fields;

use percipioglobal\rsndataengagement\RsnDataEngagement;
use percipioglobal\rsndataengagement\assetbundles\rsndataengagementfieldfield\RsnDataEngagementFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class RsnDataEngagementField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('rsn-data-engagement', 'RsnDataEngagementField');
    }
    ...
    public function normalizeValue($value, ElementInterface $element = null)
    {
       ...
       // $model = new RsnDataEngagementModel($value);
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'rsn-data-engagement/_components/fields/RsnDataEngagementField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(RsnDataEngagementFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').RsnDataEngagementRsnDataEngagementField(" . $jsonVars . ");");

        // Render the input template
        try {
            return Craft::$app->getView()->renderTemplate(
            'rsn-data-engagement/_components/fields/RsnDataEngagementField_input',
                [
                    'name' => $this->handle,
                    'value' => $value,
                    'field' => $this,
